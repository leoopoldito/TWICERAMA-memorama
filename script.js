...
// 5. Comprobar si las dos cartas volteadas son iguales
...
// 6. Si son un par, deshabilitarlas
...
// 7. Si no son un par, voltearlas de nuevo
...
// 8. Resetear el estado del turno
function resetBoard() {
    flippedCards = [];
    lockBoard = false;
}

// 9. Incrementar el contador de movimientos
